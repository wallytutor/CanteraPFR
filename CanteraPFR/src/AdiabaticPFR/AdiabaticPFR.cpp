...
#include "AdiabaticPFR.hpp"

int Cantera::AdiabaticPFR::getInitialConditions(const doublereal t0,
...
int Cantera::AdiabaticPFR::evalResidNJ(const doublereal t,

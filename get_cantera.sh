...
###############################################################################
# Default build steps
# FIXME the current is really bad!
# SUNDIALS_LIB_PATH
# SUNDIALS_INC_PATH
# SUNDIALS_LIBS = $(SUNDIALS_LIB_PATH) -lsundials_ida -lsundials_nvecserial
# CANTERA_LIB_PATH
# CANTERA_INC_PATH
# CANTERA_LIBS := $(CANTERA_LIB_PATH) -lcantera_shared
# LIBRARIES := $(CANTERA_LIBS) $(SUNDIALS_LIBS)
# INCLUDES  := $(CANTERA_INC_PATH) $(SUNDIALS_INC_PATH) CanteraPFR/include
###############################################################################
...
function header()
{
    ...
    echo "EXTERNAL := ${prefix}" >> ${makefile_in}
    echo "OPTIONS  := ${cxx_flags}" >> ${makefile_in}
    echo "SUNDIALS_PATH := ${prefix}/lib" >> ${makefile_in}
    echo "CANTERA_PATH  := ${prefix}/lib" >> ${makefile_in}
    echo "SUNDIALS_LIBS := -lsundials_ida -lsundials_nvecserial" >> ${makefile_in}
    echo "CANTERA_LIBS  := -lcantera${shared} " >> ${makefile_in}
    echo "OPENBLAS := ${openblas}" >> ${makefile_in}
